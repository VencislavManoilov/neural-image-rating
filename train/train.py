...
def check_and_install_packages():
    ...
    if missing_packages:
        ...
        print("Package installation complete. Restarting script...")
        
        # Re-execute the script with the same arguments
        os.execv(sys.executable, [sys.executable] + sys.argv)
    
    # Now that we know we have all packages, import them
    global pd, train_test_split, load_dotenv
    import pandas as pd  # type: ignore
    from sklearn.model_selection import train_test_split  # type: ignore
    from dotenv import load_dotenv  # type: ignore

# Check packages at the beginning of the script
